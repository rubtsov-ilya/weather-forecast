...
const fetchWeatherData = async () => {
  ...
  for (let i = 0; i < weatherData.daily.dayOfWeek.length; i++) {
    console.log(
      weatherData.daily.dayOfWeek[i],
      weatherData.daily.weatherCode[i],
      weatherData.daily.temperature2mMax[i].toFixed(2),
      weatherData.daily.temperature2mMin[i].toFixed(2),
      weatherData.daily.uvIndexMax[i].toFixed(2),
      weatherData.daily.precipitationProbabilityMax[i].toFixed(2)
    );
  }
};
